...
/**
 * ---------------------------------------------------------------------------------------
 * Método Funciones como Parámetros
 * ---------------------------------------------------------------------------------------
 * 
 * Ejercicio
...
const atm_collect = function (collectQty){
...
const atm_deposit = function (depositQty){
...
const atm_balance_query = function (){
...
const atm_transfer = function (accountNum, transferQty){
